...
public class DummyObserverDataConsumer<T> implements ObserverDataConsumer<T>
{
    private static final Logger logger = Logger.getLogger(DummyObserverDataConsumer.class.getName());

    public DummyObserverDataConsumer(DataFlowNode dataFlowNode, String methodName, Class<T> dataClass)
    {
